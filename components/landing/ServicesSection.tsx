        ...
        <div className="mt-12 grid auto-rows-[320px] gap-4 md:auto-rows-[280px] md:grid-cols-3 lg:auto-rows-[290px] xl:auto-rows-[270px]">
          {landingData.services.map((service, index) => (
            ...
            >
              ...
              />
              <div className="absolute inset-0 bg-gradient-to-t from-[var(--services-overlay-from)] via-[var(--services-overlay-via)] to-[var(--services-overlay-to)] transition-colors duration-500 group-hover:from-[rgba(10,9,8,0.2)]" />
              ...
              <div className="relative flex h-full flex-col justify-end p-6 sm:p-7">
                <span className="mb-4 inline-flex w-fit max-w-full rounded-full border bg-[var(--services-badge-bg)] px-3 py-1 text-[11px] font-semibold uppercase tracking-[0.2em] text-[var(--gold)]">
                  {service.badge}
                </span>
