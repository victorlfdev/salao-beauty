          ...
          {landingData.gallery.images.map((image, index) => (
            ...
            >
              ...
              */}
              ...
              />
              <div className="absolute inset-0 bg-[var(--gallery-overlay-bg)] opacity-90 transition-opacity duration-500 group-hover:opacity-100" />
              <figcaption className="absolute inset-x-0 bottom-0 p-5 text-sm text-[var(--muted-strong)] bg-[var(--gallery-caption-bg)] opacity-0 transition-opacity duration-500 group-hover:opacity-100 text-shadow-[0_2px_4px_rgba(0,0,0,0.9)]">
                {image.alt}
              </figcaption>
            </motion.figure>
          ))}
